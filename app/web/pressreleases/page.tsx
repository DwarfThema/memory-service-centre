      ...
      {lang ? (
        <div className="w-[55%] bg-white flex p-20 flex-col">
          ...
          <div>
            <div className="flex justify-center my-10 items-center flex-col ml-3">
              <Image
                src={pressContentsObjKor[pressContents].pictureUrl}
                width={350}
                height={350}
                alt="pressPhoto"
              />
        ...
        <div className="w-[55%] bg-white flex p-20 flex-col">
          ...
          <div>
            <div className="flex justify-center my-10 items-center flex-col ml-3">
              <Image
                src={pressContentsObjEng[pressContents].pictureUrl}
                width={350}
                height={350}
                alt="pressPhoto"
              />
...
const pressContentsObjKor = [
  ...
  },
  {
    ...
    contents: `메모리 서비스 센터 (이하 MSC)가 세계 최초로 기억 조작 기관으로 승인받았으며, 이로써 개인의 기억을 서비스 및 치료 형태로써 조작할 수 있는 기술을 단계적으로
      상용화할 것으로 밝혀졌다.\n\nMSC는 기억규제부 (이하 MMR)의 엄격한 검토를 통과하고, FDA로부터 정식으로 승인된 8가지 서비스를 제공하기 위한 권한을 얻었다. 이 중에는 인공 해마 이식, 트라우마 기억 삭제, 기억 복구 등 다양한 치료법이 포함되어 있으며, 이러한 서비스들은 정신 건강 문제와 관련된 다양한 상황에서 개인의 기억을 개선하고 관리하는
      데 도움을 줄 것으로 예상된다.\n\n이르면 2042년 11월부터 이러한 서비스를 제공할 예정으로, 이 기술의 도입으로 개인의 기억은더 효과적으로 관리되고 조작될 수 있게 될 것으로 전망된다. 이를 통해 정신 건강 분야에서의혁신적인 변화가 예상되며, 또한 윤리적 및 법적 문제에 대한 논의도 계속될 것으로 보인다.\n\n MSC 대표는 "우리의 목표는 개인의 행복과 웰빙을 증진시키는 데 있으며, 이를 위해 기술과 윤리적 가이드라인을 결합하여 안전하고 효과적인 서비스를 제공할 것"이라고 밝혔으며, 이러한 기술이 사회적으로 적절한 방식으로 활용되도록 주의 깊게 관리할 것임을 강조했다.\n\nMSC의 이러한 발전은 기억과 정신 건강 분야에서의 혁신적인 전환을 암시하며, 미래에는 이와관련된 연구와 개발이 더욱 확대될 것으로 예상된다.
      `,
  ...
  },
  {
    ...
    contents:
      '국제뇌협회의 이사장인 토머스 레이가 기억 조작과 관련된 범죄에 대한 규제 방안을 지속적으로 연구하겠다고 발표했다. 이러한 연구는 기억 조작 기술의 발전으로인해 발생할 수 있는 다양한 범죄에 대처하기 위한 중요한 노력으로 강조되고 있다.\n\n레이 이사장은 "기억 조작 기술은 혁신적이지만, 그와함께 범죄와 윤리적 문제도 증가하고 있습니다. 우리는이러한 문제를 해결하기 위해 최선을 다하고, 법령과 규제를 강화하는 방안을 연구하고자 합니다"라고 밝혔다.\n\n이러한 노력은 기억 조작에 대한 규제와 관련된 법령의필요성을 강조하는 것으로, 현재의 법령을 보다 효과적으로 개선하고자 하는 것을 목표로 하고 있다.\n\n레이 이사장은 "우리는 뇌 기술의 발전과 함께 발생하는 윤리적, 사회적 문제에 적극적으로 대처하고자 합니다. 안전하고 윤리적인 방향으로 진행될 수 있도록 최선을 다하겠습니다"라며 연구에대한 의지를 강조하며 동시에 “문명 시대 이전부터 그래왔듯 인류는 언제나 새로운 기술을 직면하게 되면서 시행착오를 겪을 수 밖에 없다. 다만, 우리가 해야 할 일은 이를 피하거나 감추지 않고 보다 나은 방향으로 이끌어가는 것”이라고 강조했다.\n\n실제로 작년 12월에 집계된 리플리 환자 중 기억 조작 이력이 있는 환자들의 비율이 30.8%로 조사된 바 있으며, 지난 3일 스페인 마드리드에서 일어났던 총격사건의 범인은 기억 조작 시술 이후 자기 자신을 부정하는 테세우스 증후군을 앓고 있던 환자였던 것으로 밝혀졌다.\n\n기억 조작 기술은 현재 다양한 분야에서 연구되고 있으며, 이에 따른 법령 및 규제는 미래에 더욱 중요한 역할을 할 것으로 예상된다.',
  ...
  },
  {
    ...
    contents:
      "메모리 서비스 센터 (이하 MSC)가 인공해마 칩의 대규모 계약을 Hippo&campus Co., Ltd와 체결했다. 이 계약은 인공해마 칩의 생산과 서비스 확대를 위한 뜻깊은협력을 의미하며, 계약 규모는 총 3000억 원에 달한다.\n\nHippo&campus Co., Ltd는 미국 뉴욕주에 위치한 기술기업으로, 고급 인공해마 칩의 개발과 생산 분야에서선도적인 위치를 차지하고 있다. 이번 계약으로 MSC는고객에게 제공하는 인공해마 칩의 품질과 생산량을 더욱 향상시킬 수 있게 되었다.\n\n해당 계약에 따르면 MSC는 Hippo&campus 사에 1000억 원의 선계약금을 지불 후, 잔여금 2000억 원을 향후2046년까지 순차적으로 지불할 예정이다. 이러한 조건은양사의 장기적인 협력을 반영하며, 더 나은 기술 혁신과서비스 품질 제고를 지향하고 있다.\n\n또한, 이번 협력에서 환경 측면에서도 주목할 만한 내용이 있다. Hippo&campus Co., Ltd는 공장내 전력을 100% 재생에너지로 조달하는 계획을 추진 중이며, 이로써 친환경적인 생산 환경을 조성하고자 하고 있다. MSC 역시 지속 가능한 비즈니스 모델과 친환경적인 제품 생산을 적극적으로지지하고 있으며, 이번 계약은 그러한 노력의 일환으로 해석된다.\n\nMSC와 Hippo&campus Co., Ltd의 협력은 인공해마 칩 시장에서 두 기업의 경쟁력을 한층 더 강화할 것으로 예상되며, 이로써 뇌 기술 분야의 혁신과 발전에 기여할 것으로 기대된다.",
  ...
  },
  {
    ...
    contents: `미국의 인기 팝스타인 위나 맥카시가 기억 조작 기술을 "21세기식 영혼의 디톡스"로 칭찬하며, 자신도 '트라우마 기억 삭제' 서비스를 통해 대중들 앞에 설 수있게 되었다고 밝혔다.\n\n위나 맥카시는 지난 2월 'Elimination!'이라는 싱글로데뷔하여, 현재 대중들의 큰 사랑을 받고 있는 팝 아티스트로 알려져 있다. 그녀는 기억 조작 기술의 장점들에 대해 얘기하며, 이를 통해 자신의 삶에서 얻은 이점과 긍정적인 경험을 강조했다.\n\n맥카시는 "기억 조작은 21세기의 디톡스입니다. 과거의 상처나 트라우마를 극복하고, 새로운 시작을 할수 있는 기회를 제공합니다"라며 이 기술이 어떻게 개인의 영혼과 정신적인 건강에 긍정적인 영향을 미치는지에 대해 열정적으로 이야기하며, 그녀는 현재 자신의 창작과 정신적 치유를 동시에 이루어내고 있다고 설명했다.\n\n또한, 맥카시는 VMA Freshman 인터뷰에서 "주변에 과거 때문에 미래로 나아가지 못하는 사람이있다면 자신은 기억 조작을 강력하게 추천할 것"이라고 밝힌 바가 있다. 이러한 발언으로도 그녀는 기억 조작 기술이 개인의 삶에 긍정적인 영향을 미칠 수 있다는 것에 대한 강력한 지지를 표명한 셈이다.\n\nMSC 연구진들은 이러한 사례를 통해 기억 조작 기술이 인간의 삶과 정신 건강에 어떤 방식으로긍정적인 영향을 미칠 수 있는지를 지속적으로 모니터링하며, 기술의 윤리적인 사용과 혁신적인가능성을 탐구할 것으로 밝혔다.`,
