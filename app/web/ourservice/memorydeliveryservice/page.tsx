          ...
          <div className="mt-10">
            ...
            <div className="mt-10">
              ...
              <ul className="bg-gray-200 list-disc list-outside px-10 py-5 my-5">
                ...
                <li>
                  Individuals wishing to preserve their pre-deceased memories
                  (up to the backup stage)
                </li>
              </ul>
              ...
              <span className="mt-10 block">
                ...
                Once the transplantation is completed, the incised cranial area
                is closed and sutured. Subsequently, over a period of 72 hours,
                cognitive functions, mobility, and eating habits are screened
                and observed at the center to monitor for any issues.
              </span>
