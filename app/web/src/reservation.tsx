...
export default function Reservation() {
  ...
  return (
    <div className="lg:h-[55%] lg:w-[55%] zero:h-[80%] zero:w-[85%] zero:px-5 zero:pt-2 bg-contain bg-no-repeat bg-center bg-[url('/textures/web-home/Base.png')] flex text-center justify-center items-center flex-col">
      {lang ? (
        <span className="lg:text-xl lg:mt-10 lg:mr-6 zero:text-sm zero:mt-3 zero:mr-2 zero:leading-4">
        ...
        <span className="lg:text-xl lg:mt-10 lg:mr-6 zero:text-sm zero:mt-3 zero:mr-2 zero:leading-3">
