...
export default function Reservation() {
  ...
  return (
    <div className="lg:w-[800px] zero:h-[80%] zero:w-[85%] zero:px-5 zero:pt-2 bg-contain bg-no-repeat bg-center bg-[url('/textures/web-home/Base.png')] flex text-center justify-center items-center flex-col">
      {lang ? (
        <span className="lg:text-lg lg:mt-10 lg:mr-6 zero:text-sm zero:mt-3 zero:mr-2 zero:leading-4">
